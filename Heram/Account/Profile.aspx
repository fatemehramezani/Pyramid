...
<asp:Content ID="Content4" ContentPlaceHolderID="DescriptionContent" runat="Server">
    خریدار گرامی، در این قسمت می توانید اطلاعات پروفایل را ویرایش کنید.
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="vars_fields_section">
        <div class="rows">
            <div class="input_section">
                ...
                <br />
                <br />
                <label id="FirstName">نام خریدار</label>
            ...
            <div class="input_section">
                ...
                <br />
                <br />
                <label id="LastName">نام خانوادگی خریدار</label>
        ...
        <div class="rows">
            <div class="input_section">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="MobileTextBox"
                    ...
                    Display="Dynamic">*</asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="MobileRegularExpressionValidator" ValidationExpression="\d{10}" runat="server" ControlToValidate="MobileTextBox" ErrorMessage="لطفا شماره موبایل را بدون صفر وارد نمایید"></asp:RegularExpressionValidator>
            ...
            <div class="input_section">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationExpression="\d{10}" runat="server" ControlToValidate="PhoneTextBox" ErrorMessage="لطفا تلفن را بدون صفر وارد نمایید"></asp:RegularExpressionValidator>
            </div>
            </div>
      <div class="rows">
             <div class="input_section">
    ...
    <div class="vars_container">
        <asp:Button ID="ConfirmButton" runat="server" OnClick="ConfirmButton_Click" Text="ویرایش" />
    </div>
