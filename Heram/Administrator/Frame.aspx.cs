...
public partial class Administrator_Frame : System.Web.UI.Page
{
    ...
    {
        string imagePath = "~/App_Themes/Default/images/compare/frame";
    ...
    private CustomImageButton[] GetButtons(string f)
    {
        ...
        li.Add(new CustomImageButton("../App_Themes/Default/images/messagebox_critical.png", "../Administrator/Frame.aspx" + "&goto=del&thisfile=" + f, "حذف"));
        return li.ToArray();
    ...
    private void SaveImages()
    {
        ...
        System.Drawing.Image maxThumbNailImg = maxFullSizeImg.GetThumbnailImage(415, 310, maxDummyCallBack, IntPtr.Zero);
        ...
        System.Drawing.Image maxThumbNailImg1 = maxFullSizeImg1.GetThumbnailImage(50,50, maxDummyCallBack1, IntPtr.Zero);
