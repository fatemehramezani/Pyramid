...
{
    protected string imagePath = "~/Files/Banner";
    ...
    private void SaveImages()
    {
        ...
        string maxFile = imgpath + "\\banner.jpg";
        ...
        System.Drawing.Image maxThumbNailImg = maxFullSizeImg.GetThumbnailImage(Math.Min(maxFullSizeImg.Width, 1600), Math.Min(maxFullSizeImg.Height, 150), maxDummyCallBack, IntPtr.Zero);
