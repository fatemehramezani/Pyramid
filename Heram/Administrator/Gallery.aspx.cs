...
{
    protected string imagePath = "~/Files/Gallery";
    ...
    private void SaveImages()
    {
        ...
        System.Drawing.Image maxThumbNailImg = maxFullSizeImg.GetThumbnailImage(Math.Min(maxFullSizeImg.Width, 1170), Math.Min(maxFullSizeImg.Height, 375), maxDummyCallBack, IntPtr.Zero);
