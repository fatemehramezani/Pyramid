<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/PanelMasterPage.master"    AutoEventWireup="true" CodeFile="Gallery.aspx.cs" Inherits="Admin_Gallery" %>
    ...
    <div>
        ...
        <asp:MultiView ID="ImageMultiView" runat="server">
            ...
            <asp:View ID="FileView" runat="server">
                <div style="overflow: auto; width: 95%; border: 1px gray solid; padding: 10px; margin: 0px auto;">
