...
namespace ClassLibrary.SmsSender {
    using System;
    ...
    public partial class Send : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Send() {
            this.Url = global::ClassLibrary.Properties.Settings.Default.ClassLibrary_SmsSender_Send;
        ...
        public int[] GetDeliveries(long[] recIds) {
        ...
        /// <remarks/>
        public void GetDeliveriesAsync(long[] recIds) {
            this.GetDeliveriesAsync(recIds, null);
        }
        
        /// <remarks/>
        public void GetDeliveriesAsync(long[] recIds, object userState) {
            ...
            this.InvokeAsync("GetDeliveries", new object[] {
                        recIds}, this.GetDeliveriesOperationCompleted, userState);
        }
